...
```powershell
cd C:\Users\duyth\Documents\band-room-management\band-room-management-clean\cloudflare-ai-worker
npm install
```
...
```powershell
cd C:\Users\duyth\Documents\band-room-management\band-room-management-clean\backend
