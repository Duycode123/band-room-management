...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:8080")}/api/auth/login`, formData);
...
_s(LoginPage, "jTmQMVf6K7iuhkQCN28PEGAM1lc=", false, function() {
    return [
...
//# sourceMappingURL=app_%28auth%29_login_page_tsx_0_bqif1._.js.map