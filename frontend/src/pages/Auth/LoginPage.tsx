...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen bg-brand-bgGray font-sans antialiased">
            {/* CỘT TRÁI - BANNER MÀU XANH LÁ ĐẬM TỐI GIẢN (GIỐNG HỆT REGISTER) */}
            ...
            {/* CỘT PHẢI - FORM ĐĂNG NHẬP ĐỒNG BỘ TỶ LỆ KÍCH THƯỚC 1:1 */}
            <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12">
                <div className="w-full max-w-[440px] bg-white rounded-2xl border border-gray-100 p-8 sm:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                />
                                {/* Nút icon con mắt ẩn hiện mật khẩu */}
                                <button
                                    type="button"
                        ...
                        {/* Hàng Tiện ích: Ghi nhớ đăng nhập bên trái & Quên mật khẩu bên phải */}
                        <div className="flex items-center justify-between pt-1 select-none text-xs">
                            <div className="flex items-center">
                                ...
                                />
                                <label htmlFor="remember_me" className="ml-2 font-medium text-gray-600 cursor-pointer">
                                    Ghi nhớ đăng nhập
                                </label>
                            </div>
                            <button
                    ...
                    {/* Điều hướng chuyển trang xuống Đăng ký */}
