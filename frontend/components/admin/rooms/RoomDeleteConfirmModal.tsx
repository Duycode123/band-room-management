      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="mt-3 text-sm leading-relaxed text-on-surface-variant">
            ...
            Thao tác này chỉ là mock ở frontend nhưng sau này sẽ tương ứng với API xóa phòng.
          </p>
          ...
          {room.status === 'occupied' && (
            <p className="mt-4 rounded-2xl border border-tertiary-container bg-tertiary-container/30 px-4 py-3 text-xs text-on-tertiary-container">
              Phòng đang có lịch sử dụng. Hệ thống sẽ không cho xóa cho tới khi phòng rảnh.
            </p>
          )}
