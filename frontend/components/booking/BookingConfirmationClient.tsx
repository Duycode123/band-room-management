...
export default function BookingConfirmationClient() {
  ...
  const isHomepageQuickBooking = searchParams.get('source') === 'api-booking'
  const selectionHref = apiRoom ? '/customer/booking' : '/rooms'
  const quickBookingReturnHref = isHomepageQuickBooking ? searchParams.get('returnTo') || getQuickBookingRestoreHref('/') : selectionHref
