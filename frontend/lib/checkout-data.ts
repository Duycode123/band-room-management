...
export function calculateCheckoutSummary(booking: CheckoutBooking): CheckoutSummary {
  ...
  const total = Math.max(0, roomPrice + addonsTotal + booking.serviceFee - booking.discount)
